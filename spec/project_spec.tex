...
To re-run a particular ISA test (e.g. \verb|add|) run \verb|make sim/add.fst|.

You can expect the \verb|fence_i| test to fail, and some of the store tests may fail, but the rest should pass.
