...
\verb|req_rx| is the \verb|req_tx| signal synchronized into the RX domain, and \verb|ack_rx| is the \verb|ack_tx| signal synchronized into the TX domain.
...
You should test the PWM controller using a block-level testbench and the piano software from the next section.
...
% TODO: scale.h generation instructions for different clock frequencies
