...
You will be primarily graded on trying several design points (tradeoffs between CPI and frequency) and documenting your results.
Secondarily
...
Table \ref{pll_parameters} specifies the ideal PLL parameters to get certain output frequencies.
...
To visualize the path, you can open Vivado (\verb|make vivado|), and open a DCP (Design Checkpoint) file.
File $\rightarrow$ Open Checkpoint
